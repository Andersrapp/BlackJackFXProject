package com.ar.blackjackfxproject;
...
public class Controller implements Initializable {
    ...
    @FXML
    private Label playerCard1, playerCard2, playerCard3, playerCard4, playerCard5, playerCard6, playerCard7, playerCard8, playerCard9, playerCard10;

    @FXML
    private Label dealerCard1, dealerCard2, dealerCard3, dealerCard4, dealerCard5, dealerCard6, dealerCard7, dealerCard8, dealerCard9, dealerCard10;

    @FXML
    private StackPane stackPlayerCard1, stackPlayerCard2, stackPlayerCard3, stackPlayerCard4, stackPlayerCard5, stackPlayerCard6, stackPlayerCard7, stackPlayerCard8, stackPlayerCard9, stackPlayerCard10;

    @FXML
    private StackPane stackDealerCard1, stackDealerCard2, stackDealerCard3, stackDealerCard4, stackDealerCard5, stackDealerCard6, stackDealerCard7, stackDealerCard8, stackDealerCard9, stackDealerCard10;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        hitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Label[] playerLabel = {playerCard1, playerCard2, playerCard3, playerCard4, playerCard5, playerCard6, playerCard7, playerCard8, playerCard9, playerCard10};
                StackPane[] playerStack = {stackPlayerCard1, stackPlayerCard2, stackPlayerCard3, stackPlayerCard4, stackPlayerCard5, stackPlayerCard6, stackPlayerCard7, stackPlayerCard8, stackPlayerCard9, stackPlayerCard10};
        ...
        stayButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                hitButton.setDisable(true);
                dealerHiddenCard.setVisible(false);
                Label[] dealerLabel = {dealerCard1, dealerCard2, dealerCard3, dealerCard4, dealerCard5, dealerCard6, dealerCard7, dealerCard8, dealerCard9, dealerCard10};
                StackPane[] dealerStack = {stackDealerCard1, stackDealerCard2, stackDealerCard3, stackDealerCard4, stackDealerCard5, stackDealerCard6, stackDealerCard7, stackDealerCard8, stackDealerCard9, stackDealerCard10};
    ...
    private void evaluateRoundAndPrintResult() {
        ...
        if (valueOfPlayerHand == valueOfDealerHand) {
            result.setText("Player hand: " + valueOfPlayerHand + ". Dealer hand: " + valueOfDealerHand + ". The hand is a push!");
        ...
        if (dealer.getValueOfHand() > 21) {
            result.setText("Player hand: " + valueOfPlayerHand + ". Dealer hand: " + valueOfDealerHand + ". Dealer is bust! Player wins!");
            player.addChips(player.getRoundBet() * 2);
        }
        chipsDisplay.setText("Sum: " + player.getSumOfChips());
        newRoundButton.setDisable(false);
